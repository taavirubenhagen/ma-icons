...
let t0 = class {
  ...
  get styleSheet() {
    ...
    if (q && t === void 0) {
      ...
      s && (t = D2.get(e)), t === void 0 && ((this.o = t = new CSSStyleSheet()).replaceSync(this.cssText), s && D2.set(e, t));
    }
    return t;
  }
  toString() {
...
const r0 = (i) => new t0(typeof i == "string" ? i : i + "", void 0, W), n0 = (i, ...t) => {
...
}, I2 = q ? (i) => i : (i) => i instanceof CSSStyleSheet ? ((t) => {
  let e = "";
...
const { is: a0, defineProperty: l0, getOwnPropertyDescriptor: h0, getOwnPropertyNames: d0, getOwnPropertySymbols: p0, getPrototypeOf: g0 } = Object, m = globalThis, q2 = m.trustedTypes, k0 = q2 ? q2.emptyScript : "", z = m.reactiveElementPolyfillSupport, H = (i, t) => i, T = { toAttribute(i, t) {
  ...
  return e;
} }, F = (i, t) => !a0(i, t), W2 = { attribute: !0, type: String, converter: T, reflect: !1, useDefault: !1, hasChanged: F };
...
let x = class extends HTMLElement {
  ...
  static createProperty(t, e = W2) {
    if (e.state && (e.attribute = !1), this._$Ei(), this.prototype.hasOwnProperty(t) && ((e = Object.create(e)).wrapped = !0), this.elementProperties.set(t, e), !e.noAccessor) {
      const s = Symbol(), o = this.getPropertyDescriptor(t, s, e);
      o !== void 0 && l0(this.prototype, t, o);
    }
  }
  static getPropertyDescriptor(t, e, s) {
    const { get: o, set: n } = h0(this.prototype, t) ?? { get() {
      return this[e];
    }, set(r) {
      this[e] = r;
    } };
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      ...
      for (const o of s) e.unshift(I2(o));
    } else t !== void 0 && e.push(I2(t));
    return e;
  }
  static _$Eu(t, e) {
    const s = e.attribute;
...
const u0 = (i, t) => {
  ...
  for (let a = 0; a < e; a++) {
    const c = i[a];
    let h, p, l = -1, v = 0;
    for (; v < c.length && (r.lastIndex = v, p = r.exec(c), p !== null); ) v = r.lastIndex, r === y ? p[1] === "!--" ? r = J2 : p[1] !== void 0 ? r = K2 : p[2] !== void 0 ? (o0.test(p[2]) && (o = RegExp("</" + p[2], "g")), r = b) : p[3] !== void 0 && (r = b) : r === b ? p[0] === ">" ? (r = o ?? y, l = -1) : p[1] === void 0 ? l = -2 : (l = r.lastIndex - p[2].length, h = p[1], r = p[3] === void 0 ? b : p[3] === '"' ? Q2 : G2) : r === Q2 || r === G2 ? r = b : r === J2 || r === K2 ? r = y : (r = b, o = void 0);
    const _ = r === b && i[a + 1].startsWith("/>") ? " " : "";
    n += r === y ? c + w0 : l >= 0 ? (s.push(h), c.slice(0, l) + e0 + c.slice(l) + u + _) : c + u + (l === -2 ? a : _);
  }
...
class V extends x {
  ...
  update(t) {
    const e = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(t), this._$Do = x0(e, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
    var t;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const L0 = { attribute: !0, type: String, converter: T, reflect: !1, hasChanged: F }, y0 = (i = L0, t, e) => {
...
function w(i) {
  return (t, e) => typeof e == "object" ? y0(i, t, e) : ((s, o, n) => {
...
var H0 = Object.defineProperty, S0 = Object.getOwnPropertyDescriptor, k = (i, t, e, s) => {
  for (var o = s > 1 ? void 0 : s ? S0(t, e) : t, n = i.length - 1, r; n >= 0; n--)
...
let g = class extends V {
  ...
  async modifySvg() {
    ...
    let t;
    try {
      t = new URL((/* @__PURE__ */ Object.assign({ "../icons/add-circle.svg": K, "../icons/audio.svg": G, "../icons/bottom-left.svg": Q, "../icons/bottom-right.svg": X, "../icons/camera-video.svg": Y, "../icons/camera.svg": t2, "../icons/check.svg": e2, "../icons/cmd.svg": s2, "../icons/code.svg": o2, "../icons/down.svg": i2, "../icons/download.svg": r2, "../icons/edit.svg": n2, "../icons/explore.svg": c2, "../icons/external-2.svg": a2, "../icons/fullscreen-exit.svg": l2, "../icons/fullscreen.svg": h2, "../icons/github.svg": d2, "../icons/heart-filled.svg": p2, "../icons/heart.svg": g2, "../icons/home.svg": k2, "../icons/info.svg": w2, "../icons/input.svg": v2, "../icons/instagram.svg": _2, "../icons/language.svg": u2, "../icons/left.svg": m2, "../icons/lock-closed.svg": b2, "../icons/lock-open.svg": f2, "../icons/lock.svg": C2, "../icons/login.svg": $2, "../icons/ma-2.svg": x2, "../icons/ma.svg": M2, "../icons/menu.svg": L2, "../icons/options.svg": y2, "../icons/pants.svg": A2, "../icons/pause.svg": H2, "../icons/person.svg": S2, "../icons/play.svg": V2, "../icons/remove-circle.svg": E2, "../icons/right.svg": P2, "../icons/search.svg": B2, "../icons/send.svg": O2, "../icons/settings.svg": U2, "../icons/tiktok.svg": Z2, "../icons/top-left.svg": T2, "../icons/top-right.svg": N2, "../icons/trash.svg": R2, "../icons/up.svg": z2, "../icons/youtube.svg": j2 }))[`../icons/${i}.svg`], import.meta.url).href;
    } catch {
      t = `/icons/${i}.svg`;
    }
    let e;
    try {
      e = new URL((/* @__PURE__ */ Object.assign({ "../icons/add-circle.svg": K, "../icons/audio.svg": G, "../icons/bottom-left.svg": Q, "../icons/bottom-right.svg": X, "../icons/camera-video.svg": Y, "../icons/camera.svg": t2, "../icons/check.svg": e2, "../icons/cmd.svg": s2, "../icons/code.svg": o2, "../icons/down.svg": i2, "../icons/download.svg": r2, "../icons/edit.svg": n2, "../icons/explore.svg": c2, "../icons/external-2.svg": a2, "../icons/fullscreen-exit.svg": l2, "../icons/fullscreen.svg": h2, "../icons/github.svg": d2, "../icons/heart-filled.svg": p2, "../icons/heart.svg": g2, "../icons/home.svg": k2, "../icons/info.svg": w2, "../icons/input.svg": v2, "../icons/instagram.svg": _2, "../icons/language.svg": u2, "../icons/left.svg": m2, "../icons/lock-closed.svg": b2, "../icons/lock-open.svg": f2, "../icons/lock.svg": C2, "../icons/login.svg": $2, "../icons/ma-2.svg": x2, "../icons/ma.svg": M2, "../icons/menu.svg": L2, "../icons/options.svg": y2, "../icons/pants.svg": A2, "../icons/pause.svg": H2, "../icons/person.svg": S2, "../icons/play.svg": V2, "../icons/remove-circle.svg": E2, "../icons/right.svg": P2, "../icons/search.svg": B2, "../icons/send.svg": O2, "../icons/settings.svg": U2, "../icons/tiktok.svg": Z2, "../icons/top-left.svg": T2, "../icons/top-right.svg": N2, "../icons/trash.svg": R2, "../icons/up.svg": z2, "../icons/youtube.svg": j2 }))[`../icons/${this.altname}.svg`], import.meta.url).href;
    } catch {
